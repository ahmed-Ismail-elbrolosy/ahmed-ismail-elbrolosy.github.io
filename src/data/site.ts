export const siteCopy = {
  ...
  contactLead: 'For robotics, controls, embedded systems, or mechanical design collaboration and graduate research opportunities, reach out below.',
  metaDescription: 'Ahmed Elbrolosy — Robotics and mechatronics engineer. Research interests: mobile robot navigation, underwater perception, intelligent control. Portfolio documenting ROS 2 autonomy, SLAM, embedded systems, and simulation-validated dynamics.',
};
